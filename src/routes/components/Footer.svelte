		...
		<div class="mx-auto max-w-5xl md:grid md:grid-cols-[1fr_auto_auto] md:gap-24">
			<div class="mb-8 md:mb-0 md:max-w-xs">
				...
				<div class="mt-6 flex gap-4">
					<a
						href="https://x.com/My_Decaf_Life"
					...
					<a
						href="https://www.instagram.com/my_decaf_life"
						class="text-text-500 hover:text-text-700"
					...
					<a
						href="https://www.tiktok.com/@my_decaf_life"
						class="text-text-500 hover:text-text-700"
			...
			<div class="mb-8 md:mb-0">
				...
				<nav class="flex flex-col gap-3">
					<a
						...
						target="_blank"
						class="text-text-600 hover:text-secondary-500">Reddit Community</a
					>
