<h1 class="text-text-800 my-8 mb-6 flex justify-center pt-4 text-4xl font-bold">Impressum</h1>
<div
	class="container mx-auto my-12 max-w-4xl rounded-2xl border border-gray-100 px-4 py-4 opacity-80 md:px-16 md:py-16"
>
	<section class="mb-8">
		<h2 class="mb-2 pt-2 text-xl font-semibold">Angaben gemäß § 5 TMG</h2>
		<p>NatiMate GmbH</p>
		<p>Carolinenglückstraße 35</p>
		<p>44793 Bochum</p>
	</section>

	<section class="mb-8">
		<h2 class="mb-2 text-xl font-semibold">Vertreten durch</h2>
		<p>Leonard Günther Eynck</p>
		<p>Julius Johannes Overhoff</p>
		<p>Stefan Meintrup</p>
	</section>

	<section class="mb-8">
		<h2 class="mb-2 text-xl font-semibold">Kontakt</h2>
		<p>Telefon: +4923447995230</p>
		<p>E-Mail: management@natimate.com</p>
	</section>

	<section class="mb-8">
		<h2 class="mb-2 text-xl font-semibold">Registereintrag</h2>
		<p>Eintragung im Registergericht: Bochum</p>
		<p>Registernummer: HRB 20655</p>
	</section>

	<section class="mb-8">
		<h2 class="mb-2 text-xl font-semibold">Umsatzsteuer-ID</h2>
		<p>Umsatzsteuer-Identifikationsnummer gemäß §27a Umsatzsteuergesetz: DE360584803</p>
	</section>

	<section class="mb-8">
		<h2 class="mb-2 text-xl font-semibold">Wirtschafts-ID</h2>
		<p>Folgt</p>
	</section>

	<section class="mb-8">
		<h2 class="mb-2 text-xl font-semibold">Aufsichtsbehörde</h2>
		<p>Folgt</p>
	</section>

	<section class="mb-8">
		<h2 class="mb-2 text-xl font-semibold">Haftung für Inhalte</h2>
		<p>
	...
	<section class="mb-8">
		<h2 class="mb-2 text-xl font-semibold">Haftung für Links</h2>
		<p>
	...
	<section class="mb-8">
		<h2 class="mb-2 text-xl font-semibold">Urheberrecht</h2>
		<p>
	...
	<section class="mb-8">
		<h2 class="mb-2 text-xl font-semibold">Datenschutz</h2>
		<p>
	...
	<section class="mb-8">
		<h2 class="mb-2 text-xl font-semibold">Google Analytics</h2>
		<p>
	...
	<section class="mb-8">
		<h2 class="mb-2 text-xl font-semibold">Google AdSense</h2>
		<p>
			Google AdSense Diese Website benutzt Google Adsense, einen Webanzeigendienst der Google Inc.,
			USA (''Google''). Google Adsense verwendet sog. ''Cookies'' (Textdateien), die auf Ihrem
			...
			zur Sammlung von Informationen. Durch die Verwendung des Web Beacons können einfache Aktionen
			wie der Besucherverkehr auf der Webseite aufgezeichnet und gesammelt werden. Die durch den
			Cookie und/oder Web Beacon erzeugten Informationen über Ihre Benutzung dieser Website
			(einschließlich Ihrer IP-Adresse) werden an einen Server von Google in den USA übertragen und
			dort gespeichert. Google wird diese Informationen benutzen, um Ihre Nutzung der Website im
			Hinblick auf die Anzeigen auszuwerten, um Reports über die Websiteaktivitäten und Anzeigen für
			...
			und die Anzeige von Web Beacons können Sie verhindern, indem Sie in Ihren
			Browser-Einstellungen ''keine Cookies akzeptieren'' wählen (Im MS Internet-Explorer unter
			''Extras > Internetoptionen > Datenschutz > Einstellung''; im Firefox unter ''Extras >
			Einstellungen > Datenschutz > Cookies''); wir weisen Sie jedoch darauf hin, dass Sie in diesem
			Fall gegebenenfalls nicht sämtliche Funktionen dieser Website voll umfänglich nutzen können.
